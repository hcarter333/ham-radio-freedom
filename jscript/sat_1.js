...
function Satellite(num,name,Line1,Line2){  // new satellite object
  this.Icon = new PM(num);
  this.SatPath = new LS(num);
  this.Vis = false;
  this.exVis = false;
  this.initData(name,Line1,Line2);
...
Satellite.prototype.initData = function(name,Line1,Line2) {    // initialize all the parameters associated with this satellite
